...
> **Status:** [`v0.9.10`](https://github.com/tophatch/swift-pwa/releases/tag/v0.9.10) is the current release. macOS 15+, iOS 18+, Linux (GTK3 / GTK4), Windows 11 (WebView2), and Android (API 28+) are all first-class — one Swift package, one JS API, one CLI, five platforms from the same source.
>
