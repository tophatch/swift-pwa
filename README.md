...
On-device segmentation (`ai.vision.*`) shipped in **v0.8.0** (above); `segmentAll`/AMG (automatic "segment everything" mask generation) landed post-0.8.0 on `MobileSAMBackend`, and `ai.vision.benchmark` remains fast-follow.
