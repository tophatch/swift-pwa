...
/// (`MacUpdater` on macOS, `IOSEnterpriseUpdater` on iOS, both shipped
/// from `SwiftPWAWebKit`); Linux GTK and Windows backends are pending
/// follow-ups tracked in the respective `docs/<platform>-setup.md`.
